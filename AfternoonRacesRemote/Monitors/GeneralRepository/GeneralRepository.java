...
import AfternoonRacesRemote.Monitors.RacingTrack.RacingTrack;
...
public class GeneralRepository implements GeneralRepositoryInterface{
    ...
    */
    ...
    /**
     * var indicating the number of entities 
     */
    ...
    */
     ...
     * @param name of server registry
     * @param port of server registry
     */
    public GeneralRepository(String name, int port) {
        ...
        this.rmiRegHostName = name;
        this.rmiRegPortNumb = port;
    ...
    private void terminateServers() { 
        ...
        /*
        rmiRegHostName = "l040101-ws07.ua.pt";
        rmiRegPortNumb = 22970;
        */
        ...
        try {
            BettingCenterInterface bci = (BettingCenterInterface) registry.lookup(RegistryConfig.RMI_REGISTRY_BETTINGCENTER_NAME);
            bci.signalShutdown();
        } 
        ...
        try {
            ControlCenterInterface cci = (ControlCenterInterface) registry.lookup(RegistryConfig.RMI_REGISTRY_CONTROLCENTER_NAME);
            cci.signalShutdown();
        } 
        catch (RemoteException e) {
            ...
            System.out.println("Control Center is not registered: " + e.getMessage() + "!");
            System.exit(1);
        }
        
        // shutdown Racing Track Center
        try {
            RacingTrackInterface rti = (RacingTrackInterface) registry.lookup(RegistryConfig.RMI_REGISTRY_RACINGTRACK_NAME);
            rti.signalShutdown();
        } 
        catch (RemoteException e) {
        ...
        // shutdown Paddock Center
        try {
            PaddockInterface pi = (PaddockInterface) registry.lookup(RegistryConfig.RMI_REGISTRY_PADDOCK_NAME);
            pi.signalShutdown();
        } 
        catch (RemoteException e) {
        ...
        // shutdown Stable Center
        try {
            StableInterface si = (StableInterface) registry.lookup(RegistryConfig.RMI_REGISTRY_STABLE_NAME);
            si.signalShutdown();
        } 
        catch (RemoteException e) {
